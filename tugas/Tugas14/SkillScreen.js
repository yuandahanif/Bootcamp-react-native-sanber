...
const lanuageSkill = [
  {
    name: 'HTML5',
    logoPath: require('./images/html5-original.png'),
    percent: '85',
  },
  {
    name: 'CSS3',
    logoPath: require('./images/css3-original.png'),
    percent: '80',
  },
  {
    name: 'Javascript',
    logoPath: require('./images/javascript-original.png'),
    percent: '75',
  },
  {name: 'PHP7', logoPath: require('./images/php-original.png'), percent: '75'},
];
        ...
        <FlatList
          ...
          renderItem={data => (
            <View style={styles.skillInfo}>
              <ImageLogo file={data.item.logoPath} size={28} />
